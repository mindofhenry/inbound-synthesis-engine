...
const stickyDM = node({
  ...
  config: {
    name: 'Sticky DM',
    parameters: {
      content: '## DM, not channel\n\nMIN-77 redesign: MQL ALERT header, primary contact w/ signal phrase, italic synthesis blurb, secondary contacts named-only, Explain + Show contact details buttons, footer with account/alert/score. External app deep-links removed.',
      height: 240,
      color: 6
    },
    position: [544, 176]
